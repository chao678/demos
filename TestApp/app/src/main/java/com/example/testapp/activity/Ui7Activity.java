...
import com.example.testapp.view.combobox.DropdownButton;
import com.example.testapp.view.combobox.bean.DropBean;

import java.util.ArrayList;
import java.util.List;
//下拉菜单
public class Ui7Activity extends AppCompatActivity {
