package com.example.testapp.view.ui9;
...
public class Xcircleindicator extends View {
    ...
    private int pageTotalCount = 1;//页数
    ...
    public Xcircleindicator(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public Xcircleindicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
