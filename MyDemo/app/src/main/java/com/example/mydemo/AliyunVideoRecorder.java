...
import com.example.mydemo.util.AliyunSVideoGlSurfaceView;
import com.example.mydemo.util.OrientationDetector;
import com.example.mydemo.util.RecordTimelineView;
...
//                    toSourceType();
            ...
            public void onFinish(String outputPath) {
                if(mIsToEditor)
                {
                    ...
                    mmr.release();
                    mVideoParam.setScaleMode(VideoDisplayMode.FILL);
...
//                    aliyunIImport.addVideo(outputPath,0, duration,0, AliyunDisplayMode.DEFAULT);
                    aliyunIImport.addVideo(outputPath,0, duration,new TransitionBase(), AliyunDisplayMode.DEFAULT);
